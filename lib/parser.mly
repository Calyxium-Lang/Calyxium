...
case_list:
  Pipe expr MapsTo stmt_list case_list { ($2, $4) :: $5 }
  | Pipe expr MapsTo stmt_list { [($2, $4)] }

default_opt:
  UnderScore MapsTo stmt_list { Some $3 }
  | { None }
...
expr:
  ...
  | Return expr { Ast.Expr.ReturnExpr $2 }
  | If expr Then expr Else expr { Ast.Expr.IfExpr { condition = $2; then_branch = $4; else_branch = $6; } }
...
MatchStmt:
  Match expr With case_list default_opt { Ast.Stmt.MatchStmt { expr = $2; cases = $4; default_case = $5 } }
